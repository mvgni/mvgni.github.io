<template>
    <div>
        <header>
            <div class='hamburger' style="mix-blend-mode: difference;" @click="toggleMenu()">
            <div class='line'></div>
            <div class='line'></div>
            </div>
            <div class='menu'>
                <div class='menu-item menu-home'><router-link class="hmenu" to="#slide1">home</router-link></div>
                <div class='menu-item menu-about'><router-link class="hmenu" to="#slide2">about me</router-link></div>
                <div class='menu-item menu-skills'><router-link class="hmenu" to="#slide4">skills</router-link></div>
                <div class='menu-item menu-portfolio'><router-link class="hmenu" to="/portfolio" @click="closeMenu()">portfolio</router-link></div>
